...
void initApp()
{
  ...
  robotCodeAsset = std::make_unique<PackagedStoredAsset>("code", "01223d16fa7f7494f325c9fd869c705dcad07c5022b0101867cee2eae116d938", prefPath, std::span<const uint8_t>(code_zip_bytes, sizeof(code_zip_bytes)));
