...
void initApp()
{
  ...
  robotCodeAsset = std::make_unique<PackagedStoredAsset>("code", "d07ccbdac13c8cd130a5b1b0579741068363a00130ea52031d0f68ed4c8e3cf9", prefPath, std::span<const uint8_t>(code_zip_bytes, sizeof(code_zip_bytes)));
