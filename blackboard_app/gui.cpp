...
namespace blackboard::gui
{
    ...
    void set_blackboard_theme()
    {
        ...
        colors[ImGuiCol_TitleBgActive] =
            (selection + dark_background) * ImVec4{0.5f, 0.5f, 0.5f, 1.0f};
        ...
        colors[ImGuiCol_ScrollbarGrabActive] =
            dark_alpha_selection * ImVec4{1.3f, 1.3f, 1.3f, 1.3f};
        colors[ImGuiCol_ScrollbarGrabHovered] =
            dark_alpha_selection * ImVec4{1.2f, 1.2f, 1.2f, 1.2f};
                   ...
                   const int oversample_h, const int oversample_v, const float rasterizer_multiply)
    {
        ...
        std::strncpy(font_config.Name, font_name.c_str(), IM_ARRAYSIZE(font_config.Name) - 1);
    ...
    bool load_image(void *image_data, int image_data_size, ImTexture &out_texture, uint64_t _flags)
    {
        ...
        bimg::ImageContainer *image =
            bimg::imageParse(&s_allocator, image_data, static_cast<uint32_t>(image_data_size),
        ...
        bgfx::TextureHandle textureHandle = bgfx::createTexture2D(
            ...
            bgfx::TextureFormat::BGRA8, _flags, bgfx::copy(image->m_data, image->m_size));
