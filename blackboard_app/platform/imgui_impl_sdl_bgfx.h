...
#define IMGUI_FLAGS_ALPHA_BLEND UINT8_C(0x01)
    ...
    inline bool ImageButton(bgfx::TextureHandle _handle, uint8_t _flags, uint8_t _mip,
                            ...
                            const ImVec4 &_tintCol = ImVec4(1.0f, 1.0f, 1.0f, 1.0f))
    {
        return ImGui::ImageButton("image", toId(_handle, _flags, _mip), _size, _uv0, _uv1, _bgCol,
                                  _tintCol);
    }
    ...
    inline bool ImageButton(bgfx::TextureHandle _handle, const ImVec2 &_size,
                            ...
                            const ImVec4 &_tintCol = ImVec4(1.0f, 1.0f, 1.0f, 1.0f))
    {
        return ImageButton(_handle, IMGUI_FLAGS_ALPHA_BLEND, 0, _size, _uv0, _uv1, _bgCol,
                           _tintCol);
    }
